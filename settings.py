# Django settings for republika project.
import os.path
...
ROOT_URLCONF = 'republika.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'republika.wsgi.application'
...
FACEBOOK_APP_ID              = ''
FACEBOOK_SECRET_KEY          = ''
FACEBOOK_REQUEST_PERMISSIONS = 'user_birthday, user_location, email'
